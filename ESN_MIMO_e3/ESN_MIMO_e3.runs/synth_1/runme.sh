...
HD_PWD='C:/Users/azmin/Desktop/ESN_MIMO/ESN_MIMO_e3/ESN_MIMO_e3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digitalesn_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digitalesn_top.tcl
