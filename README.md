...
- **RTL_files**: This folder contains two following subfolders :
  ...
  --> **RNN_Accelerator with Ping-Pong buffer module**: The source files for the RNN accelerator (esn_core.v) it's submodules along with testbench for core design verification with datasets and python trained weights.
