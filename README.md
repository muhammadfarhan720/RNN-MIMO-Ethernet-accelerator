...
- **SystemVerilog_RTL_design_codes**: This folder contains two following subfolders :
  ...
  --> **BIST Ethernet Testbench** : **This was the testbench file designed for verifying the AXI-Ethernet Frame transfer from the Ethernet IP core to RNN_Accelerator named (esn_core.v)**
