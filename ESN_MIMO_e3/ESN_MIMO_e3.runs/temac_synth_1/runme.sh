...
HD_PWD='C:/Users/azmin/Desktop/ESN_MIMO/ESN_MIMO_e3/ESN_MIMO_e3.runs/temac_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temac.tcl
