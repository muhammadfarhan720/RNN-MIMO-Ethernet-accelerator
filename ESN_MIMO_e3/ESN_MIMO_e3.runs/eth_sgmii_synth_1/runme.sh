...
HD_PWD='C:/Users/azmin/Desktop/ESN_MIMO/ESN_MIMO_e3/ESN_MIMO_e3.runs/eth_sgmii_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_sgmii.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_sgmii.tcl
