...
#
# Generated by export_simulation on Mon Oct 25 14:29:30 EDT 2021
#
################################################################################
...
'-reset_run' switch to the './temac.sh' script.
...
./temac.sh -noclean_files

For more information on the script, please type './temac.sh -help'.
