...
num_packets = 1600;  % 120 -> 1600 -> 6400
...
% Convert input matrix into list for loopback check
predict_inputs = reshape(inputs.', numel(inputs), 1);

% Check ESN output
figure
plot(predict_inputs); hold on
