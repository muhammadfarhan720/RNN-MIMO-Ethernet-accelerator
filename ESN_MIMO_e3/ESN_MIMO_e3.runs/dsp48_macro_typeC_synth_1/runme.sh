...
HD_PWD='C:/Users/azmin/Desktop/ESN_MIMO/ESN_MIMO_e3/ESN_MIMO_e3.runs/dsp48_macro_typeC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp48_macro_typeC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp48_macro_typeC.tcl
